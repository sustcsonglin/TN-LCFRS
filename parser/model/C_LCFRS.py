...
from ..lcfrs_cuda.lcfrs_on5 import LCFRS
...
class CompoundLCFRS(nn.Module):
    ...
    def loss(self, input):
        ...
        loss =  (result['partition'] - rules['kl'])
        return loss
    ...
    def evaluate(self, input, decode_type, **kwargs):
        ...
        result = self.lcfrs.decode(rules=rules, lens=input['seq_len'], raw_word=input['raw_word'], viterbi=False, mbr=True)
