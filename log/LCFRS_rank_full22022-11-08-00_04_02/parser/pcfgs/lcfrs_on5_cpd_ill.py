...
#
# try:
#     inside_cuda = load(name="inside_on5_cpd_ill",
#                    sources=["/public/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on5_cpd_ill/lcfrs_cpd.cpp", "/public/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on5_cpd_ill/lcfrs_cpd.cu"],
#                    verbose=True)
#
# except:
#     inside_cuda = load(name="inside_on5_cpd_ill",
#                        sources=["/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on5_cpd_ill/lcfrs_cpd.cpp", "/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on5_cpd_ill/lcfrs_cpd.cu"],
#                        verbose=True)

class InsideCPD(torch.autograd.Function):
    @staticmethod
    def forward(ctx, head_c1, head_c2, head_c3, head_d1, head_d2, left_c, right_c, left_d, right_d,
                cc, cd, dc, dd, left_d_ill, right_d_ill, unary, root, lens):
        B, L, p = unary.shape
        m = left_c.shape[1] - p
        r1 = head_c1.shape[-1]
        r2 = head_c2.shape[-1]
        ...
        alpha_d_ill = unary.new_zeros(B, L, L, L, L, r5).fill_(0)
        ...
        inside_cuda.forward(head_c1, head_c2, head_c3, head_d1, head_d2, left_c, right_c, left_d, right_d,
                cc, cd, dc, dd, left_d_ill, right_d_ill,
                unary, alpha,  alpha_d, alpha_lc, alpha_rc, alpha_ld, alpha_rd,
                alpha_cc, alpha_cd, alpha_dc, alpha_dd, alpha_d_ill,
                B, L, m, p, d, r1, r2, r3, r4, r5)
        to_return1 = (alpha[torch.arange(B), 0, lens] + root)
        to_return2 = to_return1.logsumexp(-1)
        # print(alpha)
        ctx.save_for_backward(head_c1, head_c2, head_c3, head_d1, head_d2, left_c, right_c, left_d, right_d,
                cc, cd, dc, dd, left_d_ill, right_d_ill,
                unary, alpha,  alpha_d, alpha_lc, alpha_rc, alpha_ld, alpha_rd,
                alpha_cc, alpha_cd, alpha_dc, alpha_dd, alpha_d_ill, lens, to_return1, to_return2)
        return to_return2

    @staticmethod
    def backward(ctx, gwk):
        head_c1, head_c2, head_c3, head_d1, head_d2, left_c, right_c, left_d, right_d,\
        cc, cd, dc, dd, left_d_ill, right_d_ill,\
        unary, alpha, alpha_d, alpha_lc, alpha_rc, alpha_ld, alpha_rd,\
        alpha_cc, alpha_cd, alpha_dc, alpha_dd,  alpha_d_ill, lens, t1, t2 = ctx.saved_tensors

        head_c1_grd = torch.zeros_like(head_c1)
        head_c2_grd = torch.zeros_like(head_c2)
        head_c3_grd = torch.zeros_like(head_c3)
        ...
        left_d_ill_grd = torch.zeros_like(left_d_ill)
        right_d_ill_grd = torch.zeros_like(right_d_ill)
        ...
        d = dd.shape[1]
        L+=1
        inside_cuda.backward(head_c1, head_c2, head_c3, head_d1, head_d2, left_c, right_c, left_d, right_d,
                cc, cd, dc, dd, left_d_ill, right_d_ill, unary,
                head_c1_grd, head_c2_grd, head_c3_grd, head_d1_grd, head_d2_grd, left_c_grd, right_c_grd, left_d_grd, right_d_grd,
                cc_grd, cd_grd, dc_grd, dd_grd, left_d_ill_grd, right_d_ill_grd, unary_grd,
        ...
        return head_c1_grd, head_c2_grd, head_c3_grd, head_d1_grd, head_d2_grd, left_c_grd, right_c_grd, left_d_grd, right_d_grd,\
                cc_grd, cd_grd, dc_grd, dd_grd, left_d_ill_grd, right_d_ill_grd, unary_grd, gradient_root,  None
...
class PCFG(PCFG_base):
    ...
    def _inside(self, rules, lens, viterbi=False, mbr=False):
        ...
        head_c3 = rules['head_c3']
        head_d2 = rules['head_d2']
        left_c = rules['left_c']
        left_d = rules['left_d']
        left_d_ill = rules['left_d_ill']
        right_d = rules['right_d']
        right_d_ill = rules['right_d_ill']
        ...
        dd = rules['dd']
        root = rules['root']
        return {'partition': InsideCPD.apply(head_c1, head_c2, head_c3, head_d1, head_d2, left_c, right_c, left_d, right_d,
                cc, cd, dc, dd, left_d_ill, right_d_ill, unary, root, lens)}
    ...
    def decode(self, rules, lens, viterbi=False, mbr=False):
        ...
        inside_cuda.backward(head_c1, head_c2, head_c3, head_d1, head_d2, left_c, right_c, left_d, right_d,
                ...
                alpha_cc, alpha_cd, alpha_dc, alpha_dd, alpha_d_ill,
                B, L, m, p, d, r1, r2, r3, r4, r5)
        del alpha_lc, alpha_rc, alpha_ld, alpha_rd, alpha_cc, alpha_cd, alpha_dc, alpha_dd, alpha_d_ill
