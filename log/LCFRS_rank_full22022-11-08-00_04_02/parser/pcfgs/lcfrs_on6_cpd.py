...
# #
# try:
#     inside_cuda = load(name="inside_on6_cpd",
#                    sources=["/public/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on6_cpd/lcfrs_cpd_on6.cpp", "/public/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on6_cpd/lcfrs_cpd_on6.cu"],
#                    verbose=True)
#
# except:
#     inside_cuda = load(name="inside_on6_cpd",
#                        sources=["/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on6_cpd/lcfrs_cpd_on6.cpp", "/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on6_cpd/lcfrs_cpd_on6.cu"],
#                        verbose=True)

class InsideCPDON6(torch.autograd.Function):
    @staticmethod
    def forward(ctx, head_c1, head_c2, head_d1, head_d2, head_d3,
        ...
        # alpha_ddl = unary.new_zeros(B, L, L, r4, 4).fill_(0)
        # alpha_ddr = unary.new_zeros(B, L, L, r4, 4).fill_(0)
        alpha_ddl = unary.new_zeros(B, L, L, L, L, r5).fill_(0)
        alpha_ddr = unary.new_zeros(B, L, L, L, L, r5).fill_(0)

        inside_cuda.forward(head_c1, head_c2, head_d1, head_d2, head_d3, left_c, right_c, left_d, right_d,
                cc, cd, dc, dd, ddl, ddr, unary, alpha,  alpha_d, alpha_lc, alpha_rc, alpha_ld, alpha_rd,
                  alpha_cc, alpha_cd, alpha_dc, alpha_dd, alpha_ddl, alpha_ddr,
                B, L, m, p, d, r1, r2, r3, r4, r5)
        to_return1 = (alpha[torch.arange(B), 0, lens] + root)
        to_return2 = to_return1.logsumexp(-1)
        # print(alpha)
        ctx.save_for_backward(head_c1, head_c2, head_d1, head_d2, head_d3, left_c, right_c, left_d, right_d,
                cc, cd, dc, dd, ddl, ddr, unary, alpha,  alpha_d, alpha_lc, alpha_rc, alpha_ld, alpha_rd,
                  alpha_cc, alpha_cd, alpha_dc, alpha_dd, alpha_ddl, alpha_ddr, lens, to_return1, to_return2)

        return to_return2

    @staticmethod
    def backward(ctx, gwk):
        head_c1, head_c2, head_d1, head_d2, head_d3, left_c, right_c, left_d, right_d,\
        cc, cd, dc, dd, ddl, ddr, unary, alpha, alpha_d, alpha_lc, alpha_rc, alpha_ld, alpha_rd,\
        alpha_cc, alpha_cd, alpha_dc, alpha_dd, alpha_ddl, alpha_ddr,lens, t1, t2 = ctx.saved_tensors
        ...
        head_d3_grd = torch.zeros_like(head_d3)
        ...
        ddl_grd = torch.zeros_like(ddl)
        ddr_grd = torch.zeros_like(ddr)
        ...
        d = dd.shape[1]
        L+=1
        inside_cuda.backward(head_c1, head_c2, head_d1, head_d2, head_d3, left_c, right_c, left_d, right_d,
                cc, cd, dc, dd, ddl, ddr, unary,
                head_c1_grd, head_c2_grd, head_d1_grd, head_d2_grd, head_d3_grd, left_c_grd, right_c_grd, left_d_grd, right_d_grd,
                cc_grd, cd_grd, dc_grd, dd_grd, ddl_grd, ddr_grd,
                unary_grd,
        ...
        return head_c1_grd, head_c2_grd, head_d1_grd, head_d2_grd, head_d3_grd, left_c_grd, right_c_grd, left_d_grd, right_d_grd, \
        cc_grd, cd_grd, dc_grd, dd_grd, ddl_grd, ddr_grd, unary_grd, gradient_root, None
...
class PCFG(PCFG_base):
    ...
    def _inside(self, rules, lens, viterbi=False, mbr=False):
        ...
        ddr = rules['ddr']
        root = rules['root']
        return {'partition': InsideCPDON6.apply(head_c1, head_c2, head_d1, head_d2, head_d3,  left_c, right_c, left_d, right_d,
                cc, cd, dc, dd, ddl, ddr, unary, root, lens)}
    ...
    def decode(self, rules, lens, viterbi=False, mbr=False):
        ...
        inside_cuda.backward(head_c1, head_c2, head_d1, head_d2, head_d3, left_c, right_c, left_d, right_d,
                ...
                alpha_cc, alpha_cd, alpha_dc, alpha_dd, alpha_ddl, alpha_ddr,
                B, L, m, p, d, r1, r2, r3, r4, r5)
        del alpha_lc, alpha_rc, alpha_ld, alpha_rd, alpha_cc, alpha_cd, alpha_dc, alpha_dd, alpha_ddl, alpha_ddr
