...
# #
# try:
#     inside_cuda = load(name="inside_on5_cpd_v2",
#                    sources=["/public/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on5_cpd_v2/lcfrs_cpd.cpp", "/public/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on5_cpd_v2/lcfrs_cpd.cu"],
#                    verbose=True)
#
# except:
#     inside_cuda = load(name="inside_on5_cpd_v2",
#                        sources=["/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on5_cpd_v2/lcfrs_cpd.cpp", "/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on5_cpd_v2/lcfrs_cpd.cu"],
#                        verbose=True)
...
class InsideCPD(torch.autograd.Function):
    ...
    def forward(ctx, head_c1, head_c2, head_d1, head_d2, left_c, right_c, left_d, right_d,
        ...
        alpha_dc = unary.new_zeros(B, L, L, r4).fill_(0)
