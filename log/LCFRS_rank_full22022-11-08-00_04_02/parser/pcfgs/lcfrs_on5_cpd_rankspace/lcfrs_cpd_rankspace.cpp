...
void argmax_v2(torch::Tensor &a, torch::Tensor &b, torch::Tensor &c, torch::Tensor &d, int64_t B, int64_t L){
    cuda_argmax_v2((float *) a.data_ptr(),
    (float *) b.data_ptr(),
    (float *) c.data_ptr(),
    (float *) d.data_ptr(),
    B, L);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("argmax_v2", &argmax_v2, "timex argmax");
