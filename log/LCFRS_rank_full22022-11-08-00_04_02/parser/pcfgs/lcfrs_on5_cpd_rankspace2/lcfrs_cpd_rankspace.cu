                                ...
                                int B, int L, int width, int r1, int r2)
{
    ...
    __shared__ float result_l[600];
    __shared__ float result_r[600];
    __shared__ float result_c[600];
    __shared__ float result_d1[600];
    __shared__ float result_d2[600];
    __shared__ float result_d3[600];
    __shared__ float result_d4[600];
