                                     ...
                                     int B,  int L, int r1, int r2)
{
    ...
    if(s_R==0){
        ...
        s_l[start*L*r1 + end*r1 + 0] = final_result;
    }
}
                                ...
                                int B,   int L, int width, int r1, int r2)
{
    ...
    if(s_R==0){
        ...
        for(int i=0;i<r1;i++){
            ...
            final_result_r = logsumexpf(final_result_r, result_r[i]);
        }
        ...
        if(s_A < r2){
            ...
            alpha_dc[b_idx*L*L*r2*4 + start*L*r2*4 +end*r2*4 + 0*r2 + s_A] = final_result_d1;
            alpha_dc[b_idx*L*L*r2*4 + start*L*r2*4 +end*r2*4 + 1*r2 + s_A] = final_result_d2;
            alpha_dc[b_idx*L*L*r2*4 + start*L*r2*4 +end*r2*4 + 2*r2 + s_A] = final_result_d3;
            alpha_dc[b_idx*L*L*r2*4 + start*L*r2*4 +end*r2*4 + 3*r2 + s_A] = final_result_d4;
        }
    }
}
