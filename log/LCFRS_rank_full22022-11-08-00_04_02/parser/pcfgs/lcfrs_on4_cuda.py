...
# #
# try:
#     inside_cuda = load(name="lcfrs_on4",
#                    sources=["/public/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on4_cuda/lcfrs_on4.cpp", "/public/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on4_cuda/lcfrs_on4.cu"],
#                    verbose=True)
# except:
#     inside_cuda = load(name="lcfrs_on4",
#                    sources=["/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on4_cuda/lcfrs_on4.cpp", "/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on4_cuda/lcfrs_on4.cu"],
#                    verbose=True)
            ...
            # discontinuous的span
                ...
                if idx < 0:
                    ...
                    if type == 0:
                        ...
                        prediction[b_idx][0].append((gap_start-1, gap_start))
                        prediction[b_idx][1].append((start, gap_start-1, gap_end, end))
                        backtrack(b_idx, start, gap_start-1, gap_end, end, d_symbol)
