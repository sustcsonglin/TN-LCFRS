...
#
#
inside_cuda = load(name="adssaffsda",
                   sources=["/public/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on5_rankk/lcfrs_cpd.cpp", "/public/home/yangsl/code/TN-PCFG-main/parser/pcfgs/lcfrs_on5_rankk/lcfrs_cpd.cu"],
                   verbose=True)
...
class PCFG(PCFG_base):
    ...
    def decode(self, rules, lens, viterbi=False, mbr=False,raw_word=None):
        head_dd1 = rules['head_dd1'].contiguous()
        head_cd1 = rules['head_cd1'].contiguous()
        head_dd2 = rules['head_dd2'].contiguous()
        head_cd2 = rules['head_cd2'].contiguous()
