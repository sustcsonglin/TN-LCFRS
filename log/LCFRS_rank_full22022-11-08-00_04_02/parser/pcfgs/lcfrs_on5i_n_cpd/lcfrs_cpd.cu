...
__global__ void kernel_forward_close(  F *__restrict__   head_rule,
                                 F *__restrict__   head_rule_ill,
                                 F *__restrict__ alpha,
                                 F *__restrict__ alpha_cd,
                                 F *__restrict__ alpha_cc,
                                 F *__restrict__ alpha_dd1,
                                 F *__restrict__ alpha_dd2,
                                 int B,   int L,   int width,   int m,    int r, int r2)
{
    ...
    if(start+width >= L){
      ...
      F *__restrict__   s_dd1 = alpha_dd1 + b_idx * L * L * L * L * r;
      F *__restrict__   s_dd2 = alpha_dd2 + b_idx * L * L * L * L * r;
