...
void cuda_forward(float *head_c1,   float *head_c2,   float *head_d1,   float *head_d2, float *head_d3,
                  float *left_c,   float *right_c, float *left_d,  float *right_d,
...
void cuda_backward(float *head_c1,   float *head_c2,   float *head_d1,   float *head_d2, float *head_d3,
                   ...
                   float *cc_grd,   float *cd_grd,   float *dc_grd,   float *dd_grd, float *ddl_grd, float *ddr_grd,
                   float *unary_grd,
                   float *alpha,  float *alpha_d, float *alpha_lc, float *alpha_rc, float *alpha_ld, float *alpha_rd,
                   float *alpha_cc, float *alpha_cd, float *alpha_dc, float *alpha_dd, float *alpha_ddl, float *alpha_ddr,
                   int B, int L, int m, int p, int d, int r1, int r2, int r3, int r4, int r5);
...
torch::Tensor &a24, torch::Tensor &a25, torch::Tensor &a26, torch::Tensor &a27, torch::Tensor &a28,
...
torch::Tensor &a37, torch::Tensor &a38, torch::Tensor &a39, torch::Tensor &a40, torch::Tensor &a41, torch::Tensor &a42, torch::Tensor &a43, torch::Tensor &a44,
int64_t B, int64_t L, int64_t m, int64_t p, int64_t d, int64_t r1, int64_t r2, int64_t r3, int64_t r4, int64_t r5) {
