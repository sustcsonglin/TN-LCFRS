...
void cuda_forward_argmax(const float *binary, const float *binary_d, const float *binary_c,  const float *unary, float *alpha, float *alpha_d, int B, int L, int m, int p, int d);
