...
from parser.model import NeuralPCFG, CompoundPCFG, TNPCFG,  FastTNPCFG
from parser.model.N_LCFRS import NeuralLCFRS
from parser.model.N_LCFRS_rankspace_full2 import NeuralLCFRS_rankspace_full2
...
def get_model(args, dataset):
    ...
    elif args.model_name == 'LCFRS':
        return NeuralLCFRS(args, dataset).to(dataset.device)


    elif args.model_name == 'LCFRS_rank_full2':
        return NeuralLCFRS_rankspace_full2(args, dataset).to(dataset.device)
